defmodule Handshake do
    ...
    def get_peer_socket(peer_addr) do
    ...
    def get_peer_id({:ok, socket}, encoded_str) do
    ...
    defp extract_peer_id(<<header_int::160, _ext_bytes::64, info_hash_int::160, peer_id_int::160>>, computed_info_hash) do
